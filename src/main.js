import './style.css';
const PROFILE = {"day":"Day019","title":"Challenge Chain Roulette","one_sentence":"連続ミッション達成で倍率を伸ばすルーレットゲーム。（話題:HN Frontpage）","core_action":"chain","family":"roulette_chain","mechanic":"random_spin_with_multiplier","input_style":"preset_pool","output_style":"roulette_result","audience_promise":"higher_replayability","publish_hook":"連続成功で倍率が上がる","engine":"roulette_game","interaction_archetype":"challenge_roulette_game","page_archetype":"game_stage","output_shape":"round_result_cards","state_model":"round_history_and_score","core_loop":"spin -> clear -> chain","component_pack":"roulette_wheel+multiplier_badge","scaffold_id":"roulette_game","single_shot_text_generator":false};
